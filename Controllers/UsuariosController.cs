...
namespace SISCO_SAYACv3._5.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(SISCO_SAYACv3_5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UsuariosId,usuario,contrasena,correo")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuariosId,usuario,contrasena,correo")] Usuarios usuarios)
        {
